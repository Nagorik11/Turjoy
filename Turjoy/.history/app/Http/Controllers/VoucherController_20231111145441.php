    ...
    public function store(Request $request)
    {
        try {
            ...
            $request->validate([
                ...
                'destiny' => 'required|origin',
                'seat_quantity' => 'required|integer', // Ejemplo de regla para seat_quantity
                'base_rate' => 'required|numeric',     // Ejemplo de regla para base_rate
            ]);
            ...
            // Aquí puedes definir reglas de validación específicas para manejar la excepción
            $request->validate([
                'date' => 'date|required',
                'origin' => 'required|origin',
                'destiny' => 'required|origin',
            ...
            return redirect()->back()->with('error', 'Ha ocurrido un error al guardar el comprobante.');
        }
    }
