...
class TravelController extends Controller
{
    ...
    public function getDestinations(Request $origin)
    {
        $destinations = Route::select('destiny')->where('origin', $origin)->get();
        return view('reservation', ['destinations' => $destinations]);
    }
{
    $destinations = Route::select('destiny')->where('origin', $request->origin)->get();
    return view('reservation', ['destinations' => $destinations]);
}
};
