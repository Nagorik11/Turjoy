...
class VoucherController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            // Maneja la excepción aquí, puedes mostrar un mensaje de error, registrar la excepción, o realizar otra acción apropiada.
            return back()->with('error', 'Ha ocurrido un error al guardar el comprobante.');
        }
    }
