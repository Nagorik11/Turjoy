...
Route::group(['namespace' => 'App\Http\Controllers'], function()
{
   ...
   // Route::post('/search-voucher', [VoucherController::class,'searchVoucher'])->name('voucher.search');
    ...
    Route::get('/reservation', [ReservationController::class,'showOrigins'])->name('reservation.origin');
    Route::get('/reservation', 'TravelController@getOrigins');
    
    Route::get('/reservation', [ReservationController::class,'showDestinations'])->name('reservation.destination');
    Route::get('/reservation', 'TravelController@getDestinations');
