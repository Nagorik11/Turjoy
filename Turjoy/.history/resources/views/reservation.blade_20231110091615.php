/**
 * This file contains the HTML and PHP code for the reservation page of the Turjoy website.
 * It includes a form for reserving a seat on a route, with fields for selecting the date, origin, destination, and number of seats.
 * The form also includes a submit button for submitting the reservation request.
 * The page uses Bootstrap and jQuery for styling and functionality.
 */
/**
 * This file contains the HTML and PHP code for the reservation page of the Turjoy website.
 * It includes a form for reserving a seat on a route, with fields for selecting the date, origin, destination, and number of seats.
    ...
    <div class="card mx-auto mb-5 mt-4">
        ...
        <form action="{{ route('reservation.store') }}" method="POST" style="margin: 20px auto 0; max-width:500px;">
            ...
            <div class="form-group">
                ...
                <label for="base_rate">Precio por Asiento:</label>
                @foreach(route->base_rate)
                <option value="{{ $route->base_rate }}">{{ $route->base_rate}}</option
