    ...
    <div class="card mx-auto mb-5 mt-4">
        ...
        <form style="margin: 20px auto 0; max-width:500px;">
            ...
            <div class="form-group">
                ...
                <label for="destination">Destino:</label>
                <div>
                    <select name="destination" id="destination-select" class="selectpicker form-control" data-flag="true" data-width="500px">
                        @foreach($routes as $route)       
                            <option value="{{ $route->destiny }}" data-origin="{{ $route->origin }}">{{ $route->destiny }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <script>
                    ...
                    originSelect.addEventListener('change', () => {
                        ...
                        destinationOptions.forEach(option => {
                            if (option.dataset.origin !== selectedOrigin) {
