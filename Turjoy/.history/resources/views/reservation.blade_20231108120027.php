...
<body>
    <div class="card mx-auto mb-5 mt-4">
        ...
        <form style="margin: 20px auto 0; max-width:500px;">
            ...
            <div>
                <select name="destination" id="destinationSelect" class="selectpicker form-control" data-flag="true" data-width="500px">
                    @foreach($routes as $route)       
            ...
            <script>
                function filterDestinations() {
                    ...
                    const filteredDestinations = destinations.filter(destination => destination !== origin);
