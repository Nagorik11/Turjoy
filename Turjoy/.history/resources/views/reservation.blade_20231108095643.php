...
<body>
    <div class="card mx-auto mb-5 mt-4">
        ...
        <form style="margin: 20px auto 0; max-width:500px;">
            ...
            <div class="form-group">
                ...
                <div>
                    <select name="origin" class="select2 form-control" style="width: 100%;">
                        @foreach ($route as $routex)
                            <option value="{{ $routex->origin }}">{{ $routex->origin }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div>
                    <select name="destination" class="select2 form-control" style="width: 100%;">
                        @foreach ($route as $routex)
                            <option value="{{ $routex->id }}">{{ $routex->id }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var destinationMap = {
                @foreach ($route as $routex)
                    "{{ $routex->origin }}": "{{ $routex->destination }}",
                @endforeach
            };
