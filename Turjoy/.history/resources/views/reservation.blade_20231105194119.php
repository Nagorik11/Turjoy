...
<body>
    <div class="card mx-auto mb-5 mt-4">
        ...
        <form class="card-body" action="{{ route('reservation.store') }}" method="POST">
            @csrf
            <div class="form-group">
                <label for="origen">Origen:</label>
                <div>
                    <select class="selectpicker form-control" data-live-search="true" name="origen" id="origens">
                        <option value="origin" selected disabled>Seleccione un origen</option>
            ...
            <div class="form-group">
                ...
                <div>
                    <select class="selectpicker form-control" data-live-search="true" name="destino" id="destino">
                        <option value="destiny" selected disabled>Seleccione un destino</option>
