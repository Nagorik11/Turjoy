    ...
    <div class="card mx-auto mb-5 mt-4">
        ...
        <form style="margin: 20px auto 0; max-width:500px;">
            ...
            <div class="form-group">
                ...
                <div>
                    <select name="route" class="selectpicker form-control" data-flag="true" data-width="500px">
                    @foreach ($route as $routez)
                        <option value="{{ $routez->origin }}">{{ $routez->id }}</option>
                        @endforeach
                    </select>
                <label for="destination">Destino:</label>
                    ...
                    <select name="destination" class="selectpicker form-control" data-flag="true" data-width="500px">
                        ...
                        @if ($routez->origin)
                        <option value="{{$routez}}">{{ $route }}</option>
                        @endif
                    </select>
                </div>
            </div>
