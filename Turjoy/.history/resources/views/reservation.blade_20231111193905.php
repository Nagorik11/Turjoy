...
<script>
    ...
    var seat_quantuty = document.getElementById('seat_quantity');

    // Agrega un controlador de eventos para el evento 'input' (cuando el valor cambia)
    seatQuantityInput.addEventListener('input', function() {
        // Obtiene el valor del input y conviértelo a un número
        var selectedSeatQuantity = parseInt(seatQuantityInput.value, 10);

        // Hacer algo con el valor, por ejemplo, mostrarlo en la consola
        console.log('Cantidad de asientos seleccionada: ' + selectedSeatQuantity);
    });
</script>
